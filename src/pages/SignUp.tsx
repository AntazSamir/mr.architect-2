    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-[20%] right-[10%] w-[50%] h-[50%] rounded-full bg-primary/10 blur-[120px] animate-pulse-slow" />
                <div className="absolute bottom-[10%] left-[10%] w-[30%] h-[50%] rounded-full bg-accent/10 blur-[100px] animate-pulse-slow delay-1000" />
                <div className="absolute top-[40%] left-[40%] w-[40%] h-[40%] rounded-full bg-secondary/20 blur-[120px]" />
            </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <CardFooter className="flex flex-col space-y-4">
                            ...
                            <div className="text-center text-sm">
                                ...
                                <Link to="/signin" className="text-primary hover:text-primary/80 font-medium hover:underline transition-all">
                                    Sign in
                                </Link>
                            </div>
                        </CardFooter>
